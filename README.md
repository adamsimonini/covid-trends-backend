...
8. There are two options to seed the database:
   ...
   1. predefined, manually created records via [fixtures](https://docs.djangoproject.com/en/4.0/howto/initial-data/) located in ./app/backend_api/fixtures. To do so, use the following command:
   ...
   ```
   docker compose exec web python manage.py seed backend_api --number=15
   ```
