"""
Django settings for public_health_trends project.
...
# SECRET_KEY = 'django-insecure-bv-_@60rgy&fbsxd0r-lauk&fj4zw%6s)r6b$$yn+8+ajs7vsi'
...
ROOT_URLCONF = 'public_health_trends.urls'
...
WSGI_APPLICATION = 'public_health_trends.wsgi.application'
...
if DEBUG:
    ...
    INTERNAL_IPS = [ip[: ip.rfind(".")] + ".1" for ip in ips] + ["127.0.0.1", "10.0.2.2", "0.0.0.8000", "localhost:8000"]
